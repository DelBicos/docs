# PRODUCT BACKLOG DELBICOS - SEGUNDO SEMESTRE 2026
...
**Documento:** Product Backlog v6.0
**Data de elaboração:** 21/08/2026
**Início do semestre:** 24/08/2026
**Duração da sprint:** 2 semanas (15 dias úteis)
...
| **2ª Entrega - Qualidade** | Qualidade e Testes de Software | 21/11/2026 | Pipeline de CI/CD (GitHub Actions) configurado, testes automatizados com Jest/JUnit/Selenium e cobertura mínima de 80% |
...
|--------|--------|---------|----------------|-----------------|
| **Sprint 1** | 24/08/2026 | 07/09/2026 | Fundação: Correções Críticas, Plano de Teste e Setup Inicial | - |
| **Sprint 2** | 08/09/2026 | 22/09/2026 | **PLN: Voz + Busca Semântica + Testes Caixa Preta/UML** | **Entrega 1 (21/09)** |
| **Sprint 3** | 23/09/2026 | 07/10/2026 | **Computação em Nuvem II: Análise e Provisionamento Inicial na Azure** | **Entrega 1 - Cloud (05/10)** |
| **Sprint 4** | 08/10/2026 | 22/10/2026 | **Chatbot Completo (TF-IDF + SVM) + Sistema de Chamados (Tickets)** | - |
| **Sprint 5** | 23/10/2026 | 06/11/2026 | **Jornada de Atendimento (Geolocalização, Evidências, Notificações) + Pipeline CI/CD + Jest** | - |
| **Sprint 6** | 07/11/2026 | 21/11/2026 | **Qualidade, Estabilização, Deploy Final e Documentação** | **Entrega 2 Cloud (16/11) / Entregas Finais (21/11)** |
...
| INFRA-02 | Como desenvolvedor, quero provisionar um **Azure Database for PostgreSQL** (ou MySQL) para os dados estruturados (usuários, agendamentos, serviços) | Crítica | Técnica | 3 |
...
#### Subgrupo B — 2ª Entrega (21/11): Pipeline CI/CD e Jest
...
| QA-05 | Como desenvolvedor, quero automatizar os casos de teste com **Jest** (ou JUnit), garantindo cobertura mínima de 80% do código | Crítica | Técnica | 5 |
...
- [ ] A cobertura de testes é de, no mínimo, 80%
...
| GEO-06 | Como desenvolvedor, quero armazenar o histórico de localização do prestador (opcional) para auditoria e rastreabilidade | Média | Técnica | 6 |
| NOT-01 | Como cliente, quero receber uma notificação push/email quando o prestador mudar o status para "A Caminho" para saber que ele está vindo | Alta | Funcional | 5 |
| NOT-02 | Como cliente, quero receber uma notificação push/email quando o prestador realizar o check-in para saber que ele chegou | Alta | Funcional | 5 |
| NOT-03 | Como cliente, quero receber uma notificação push/email quando o serviço for concluído com as fotos do antes/depois anexadas para validar o resultado | Alta | Funcional | 6 |
...
| TICKET-16 | Como desenvolvedor, quero criar o modelo de dados para chamados com todos os campos necessários para estruturar o sistema | Crítica | Técnica